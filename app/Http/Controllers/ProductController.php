    ...
    public function saveproduct(Request $request){
        //return $request;   
    		$this->validate($request, ['product_name' => 'required',
                ...
                //$path = $request->product_image->store('images','public/product_image');

               // $path = $request->product_image->store('public/product_image');
           ...
           if ($request->input('product_category')){
    		if ($request->hasFile('product_image')){
                ...
                //$path2 = Storage::disk('public')->putFile('product_image', $fileNameToStore);
    		}
