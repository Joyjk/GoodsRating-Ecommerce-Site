        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Food Factory</h2>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="http://ronchon-chocolatine-00245.herokuapp.com/" class="py-2 d-block">About</a></li>
                {{-- <li><a href="#" class="py-2 d-block">Journal</a></li> --}}
                <li><a href="http://ronchon-chocolatine-00245.herokuapp.com/" class="py-2 d-block">Contact Us</a></li>
              </ul>
            </div>
          </div>
          {{-- <div class="col-md-4">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  <li><span class="icon icon-map-marker"></span><span class="text">Mohammadpur, Dhaka</span></li>
                  <li><a href="#"><span class="icon icon-phone"></span><span class="text">+2 392 3929 210</span></a></li>
                  <li><a href="#"><span class="icon icon-envelope"></span><span class="text">krmkrjoy@gmail.com</span></a></li>
                </ul>
              </div>
            </div>
          </div>
